...
CREATE TABLE IF NOT EXISTS members (
    ...
    CONSTRAINT chk_email_address CHECK (email_address REGEXP '^[A-Za-z0-9._%+-]+@[A-Za-z0-9.-]+\.[A-Za-z]{2,}$'),
...
('010000000001', 'Juan dela Cruz', '1985-03-12', 'Manila', 'M', 'Married', 'FILIPINO', 'PSN-0001-0000-0001', 
'123 Rizal St., Sampaloc, Manila', NULL, '09171234501', '028001001', NULL, 'juan.delacruz@email.com', 'Engineer', 
45000, NULL, NULL, NULL, 'Teresa dela Cruz', 'Maria dela Cruz', 'EMP_PRIV'),

-- 2. Employed Government | Filipino | Female | Single | Teacher
('010000000002', 'Maria Santos', '1990-07-25', 'Quezon City', 'F', 'Single', 'FILIPINO', 'PSN-0001-0000-0002', 
'456 Mabini Ave., Diliman, Quezon City', NULL, '09281234502', NULL, NULL, 'maria.santos@email.com', 'Teacher', 
32000, NULL, NULL, NULL, 'Corazon Santos', NULL, 'EMP_GOV'),

-- 3. Professional Practitioner | Filipino | Male | Married | Doctor
('010000000003', 'Roberto Reyes', '1978-11-05', 'Cebu City', 'M', 'Married', 'FILIPINO', 'PSN-0001-0000-0003', 
'789 Osmeña Blvd., Cebu City', NULL, '09391234503', '032001003', '032001103', 'roberto.reyes@email.com', 'Doctor', 
120000, NULL, NULL, NULL, 'Remedios Reyes', 'Elena Reyes', 'PROF_PRAC'),

-- 4. Self-Earning Individual | Filipino | Female | Single | Freelancer
('010000000004', 'Ana Villanueva', '2000-01-18', 'Davao City', 'F', 'Single', 'FILIPINO', NULL, '321 Quirino St., 
Davao City', NULL, '09171234504', NULL, NULL, 'ana.villanueva@email.com', 'Freelancer', 18000, NULL, NULL, NULL, 
'Gloria Villanueva', NULL, 'SE_INDIV'),

-- 5. Senior Citizen | Filipino | Male | Widow/er | Retired
('010000000005', 'Carlos Mendoza', '1955-09-30', 'Iloilo City', 'M', 'Widow/er', 'FILIPINO', 'PSN-0001-0000-0005', 
'654 General Luna St., Iloilo City', NULL, '09561234505', '033001005', NULL, 'carlos.mendoza@email.com', NULL, NULL, 
...
'PSN-0001-0000-0006', '987 Ayala Ave., Makati City', NULL, '09881234506', '028001006', '028001106', 'linda.pascual@email.com', 
'Accountant', 85000, NULL, 'ACR-2024-0006', NULL, 'Rosario Pascual', NULL, 'DUAL_CTZ'),

-- 7. Foreign National | Male | Married | Consultant
('010000000007', 'James Thornton', '1975-06-22', 'London, United Kingdom', 'M', 'Married', 'FOREIGN NATIONAL', NULL, 
'111 BGC Ave., Taguig City', NULL, '09171234507', '028001007', '028001107', 'james.thornton@email.com', 'Consultant', 
200000, NULL, 'ACR-2024-0007', NULL, 'Margaret Thornton', 'Claire Thornton', 'FOR_NAT'),

-- 8. Kasambahay | Filipino | Female | Single | Household Worker
('010000000008', 'Rosario Bautista', '1998-05-10', 'Batangas City', 'F', 'Single', 'FILIPINO', NULL, 'B12 L5 Sunset Homes, Las Pinas City', 
NULL, '09451234508', NULL, NULL, 'rosario.bautista@email.com', 'Household Worker', 6000, NULL, NULL, NULL, 'Natividad Bautista', NULL, 'KASAM'),

-- 9. Migrant Worker Sea-Based | Filipino | Male | Married | Seafarer
('010000000009', 'Eduardo Navarro', '1982-08-19', 'Batangas City', 'M', 'Married', 'FILIPINO', 'PSN-0001-0000-0009', '
22 Dalisay St., Batangas City', NULL, '09321234509', '043001009', NULL, 'eduardo.navarro@email.com', 'Seafarer', 95000, 
NULL, NULL, NULL, 'Caridad Navarro', 'Liza Navarro', 'MIG_SEA'),

-- 10. PWD | Filipino | Male | Single
('010000000010', 'Fernando Garcia', '1993-12-03', 'Pasig City', 'M', 'Single', 'FILIPINO', 'PSN-0001-0000-0010', 
'45 Ortigas Ave., Pasig City', NULL, '09201234510', NULL, NULL, 'fernando.garcia@email.com', NULL, 8000, NULL, NULL, 
'PWD-2020-001234', 'Ligaya Garcia', NULL, 'PWD');
